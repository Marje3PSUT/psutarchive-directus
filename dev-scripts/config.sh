...
export SETTINGS_FILE_PATH="/directus/essentials/settings.yaml"
export TRANSLATIONS_PATH="/directus/essentials/translations"
export ASSETS_PATH="/directus/essentials/assets"
