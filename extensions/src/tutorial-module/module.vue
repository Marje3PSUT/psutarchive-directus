...
const roles = {
  administrator: {
    ...
    questions: [
      { q: t("administrator.faq.q1.q"), a: t("administrator.faq.q1.a") },
    ],
  },
  contributor: {
  ...
  moderator: {
    ...
    questions: [
      {
        q: t("moderator.faq.q1.q"),
        a: t("moderator.faq.q1.a"),
        vid: "https://www.youtube.com/embed/1zScKYPJg14",
      },
    ],
  },
};
...
const allFaqs = [
  {
    q: t("allFaqs.q1.q"),
    a: t("allFaqs.q1.a"),
    vid: "https://www.youtube.com/embed/yvRKTnvubfk",
  },
  {
    q: t("allFaqs.q2.q"),
    a: t("allFaqs.q2.a"),
    pic: "https://i.imgur.com/yBgS2GD.png",
  },
  {
    q: t("allFaqs.q3.q"),
    a: t("allFaqs.q3.a"),
    vid: "https://www.youtube.com/embed/Tdet3mSG9_M",
  },
  {
    q: t("allFaqs.q4.q"),
    a: t("allFaqs.q4.a"),
    pic: "https://i.imgur.com/4TXhmey.png",
  },
  {
    q: t("allFaqs.q5.q"),
    a: t("allFaqs.q5.a"),
    pic: "https://i.imgur.com/y8aBJgK.png",
  },
];
          ...
          <div v-if="activeAccordion === index" class="accordion-drawer">
            ...
            <div v-if="item.vid" class="content-container">
              <iframe
                ...
                :src="
                  item.vid +
                  '?cc_load_policy=1&autoplay=1&mute=1&modestbranding=1&rel=0'
                "
                frameborder="0"
            ...
            <div v-if="item.pic" class="content-container">
              <img class="img-tut" :src="item.pic" />
            </div>
          </div>
        </div>
      </div>
